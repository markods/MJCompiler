...
public class FormParsNextFormPar extends FormParsNext {

    private Type Type;
    private VarIdent VarIdent;
    private FormPars FormPars;

    public FormParsNextFormPar (Type Type, VarIdent VarIdent, FormPars FormPars) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParsNextFormPar(\n");
