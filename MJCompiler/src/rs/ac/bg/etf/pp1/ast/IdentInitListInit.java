...
public class IdentInitListInit extends IdentInitList {

    private String i1;
    private Assignop Assignop;
    private Literal Literal;

    public IdentInitListInit (String i1, Assignop Assignop, Literal Literal) {
        this.i1=i1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IdentInitListInit(\n");
