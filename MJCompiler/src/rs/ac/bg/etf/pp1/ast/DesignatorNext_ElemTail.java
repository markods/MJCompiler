...
public class DesignatorNext_ElemTail extends DesignatorNext {

    private Expr Expr;
    private DesignatorNext DesignatorNext;

    public DesignatorNext_ElemTail (Expr Expr, DesignatorNext DesignatorNext) {
        this.Expr=Expr;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorNext_ElemTail(\n");
