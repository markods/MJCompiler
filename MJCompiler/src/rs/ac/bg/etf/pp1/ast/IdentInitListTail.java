...
public class IdentInitListTail extends IdentInitList {
    ...
    public IdentInitListTail (String i1, Assignop Assignop, Literal Literal, IdentInitList IdentInitList) {
        this.i1=i1;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("IdentInitListTail(\n");
