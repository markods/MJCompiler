...
public class GlobalDeclList_Tail extends GlobalDeclList {

    private GlobalDecl GlobalDecl;
    private GlobalDeclList GlobalDeclList;

    public GlobalDeclList_Tail (GlobalDecl GlobalDecl, GlobalDeclList GlobalDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("GlobalDeclList_Tail(\n");
