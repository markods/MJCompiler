...
public class SignedAdditionTail extends SignedAddition {

    private Addop Addop;
    private Term Term;
    private SignedAddition SignedAddition;

    public SignedAdditionTail (Addop Addop, Term Term, SignedAddition SignedAddition) {
        this.Addop=Addop;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SignedAdditionTail(\n");
