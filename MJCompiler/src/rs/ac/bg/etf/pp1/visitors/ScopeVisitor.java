...
public class ScopeVisitor implements Visitor
{
    ...
    public int getTokenStartIdx() { return ( min != Integer.MIN_VALUE ) ? min : CompilerError.NO_INDEX; }
    public int getTokenEndIdx()   { return ( max != Integer.MIN_VALUE ) ? max : CompilerError.NO_INDEX; }
    ...
    public void visit( CondTermScope             node ) { updateScope( node ); }
    public void visit( Addop                     node ) { updateScope( node ); }
    public void visit( DesignatorStmt            node ) { updateScope( node ); }
    public void visit( IfScope                   node ) { updateScope( node ); }
    ...
    public void visit( CondNest                  node ) { updateScope( node ); }
    ...
    public void visit( Aorop_Or                  node ) { updateScope( node ); }
    public void visit( Aorop_And                 node ) { updateScope( node ); }
    ...
    public void visit( CondTermScope_Plain       node ) { updateScope( node ); }
    public void visit( CondFact_Relop            node ) { updateScope( node ); }
    public void visit( CondFact_Expr             node ) { updateScope( node ); }
    public void visit( CondNest_Tail             node ) { updateScope( node ); }
    public void visit( CondNest_Head             node ) { updateScope( node ); }
    public void visit( CondTerm_Nest             node ) { updateScope( node ); }
    public void visit( CondTerm_Fact             node ) { updateScope( node ); }
    public void visit( CondTermList_Tail         node ) { updateScope( node ); }
    public void visit( CondTermList_Aor          node ) { updateScope( node ); }
    public void visit( Condition_Multi           node ) { updateScope( node ); }
    public void visit( Condition_Single          node ) { updateScope( node ); }
    ...
    public void visit( DoWhileStmt_Plain         node ) { updateScope( node ); }
    ...
    public void visit( IfScope_Plain             node ) { updateScope( node ); }
