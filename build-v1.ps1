...
{
    Write-Output "build   [[-]-help]   [-jflex] [-cup [-pst]]   [-clean] [-build]   [-compile [-verbose] [-lex file] [-par file] [-o file] file]   [-disasm file] [-run [-debug] file]";
    Write-Output "";
    Write-Output "Default:        build -cup -jflex -build";
    Write-Output "";
...
if( "-cup" -in $args )
{
    ...
    $BuildCmd = "java",
        ...
        "-ast", "rs.ac.bg.etf.pp1.ast", "-buildtree";
    ...
    if( Test-Path "./rs/ac/bg/etf/pp1/ast" -PathType "Container" ) { Remove-Item "./rs/ac/bg/etf/pp1/ast" -Recurse | Out-Null; }
